...
def cmdline():
    ...
    a.add_argument('--repeat', type=int, default=1, help='Repeat the synthesis how many times')
    a.add_argument('--timeout', type=int, default=300, help='Timeout limit')
    return a.parse_args()
...
if __name__ == '__main__':
    ...
    if cl_opts.synthesis or cl_opts.all:
        run_synthesis(groups, cl_opts.output_dir, cl_opts.tsv_prefix, repeats=cl_opts.repeat, timeout=cl_opts.timeout)
